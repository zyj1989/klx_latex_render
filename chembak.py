...
def str2latex(ori):
    ...
    def unicode_2_latex(s):
        unicode2latex = [
            ...
            (ur'\u2468', ur'{\text{\ding{180}}}'),
            (ur'\u2469', ur'{\text{\ding{181}}}'),
            (ur'\u2160', ur'{\text{$\mathrm{I}$}}'),  # roman numbers
...
output_dir = '/Users/zhangyingjie/var/data/img'
...
item_ids = [
    ...
    ObjectId("56b1b8d95417d15f07873085")
]
